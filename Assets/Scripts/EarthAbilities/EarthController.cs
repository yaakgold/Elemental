...
public class EarthController : MonoBehaviour
{
    ...
    public void OnAbility1()
    {
        ...
        rock.GetComponent<RockThrow>().RockInitial(speed, transform.position + (transform.up) + (transform.forward * 2));
    }

    public void OnAbility2()
    {
        Vector3 position = new Vector3(transform.position.x, transform.position.y + 1, transform.position.z + 5);
    ...
    public void WallStart(Vector3 position, Vector3 startPosition)
    {
        ...
        GameObject earthWall = Instantiate(WallObj, startPosition, Quaternion.identity) as GameObject;
